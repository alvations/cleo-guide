#!/usr/bin/env python3
# Merge geocode-agent output (_geoout_*.json) into data/geocodes.json under silicon-valley-ca.
...
city = g.setdefault("cities", {}).setdefault("silicon-valley-ca", {})
...
print(f"silicon-valley-ca registry entries now: {len(city)}")
