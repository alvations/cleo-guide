...
| Washington DC (+ Arlington + Dulles corridor) | `cities/washingtondc.html` | `data/washingtondc.dataset.json` | `data/washington-dc-research/` | 120 | live · 185 candidates (12 areas, deep Eden Center), 65 UNVERIFIED restaurant pins pending helper; closed rooms held |
