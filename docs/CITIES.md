...
| Saarbrücken & the Greater Region (SaarLorLux · DE/FR/LU) | `cities/saarland.html` (linked from the country hub as 🇩🇪 Germany & the Greater Region) | `data/saarland.dataset.json` | `data/saarland-research/` | 271 | live · cross-border, 5 areas: **SAAR** (Saarbrücken + Saarland), **MOSELLE** (Metz + Nancy), **LUX** (whole Grand Duchy), **MOSEL** (Trier + Mosel), **ALSACE** (Strasbourg). **308 discovered, all ≥2-credible (0 single-source); 271 rendered** (187 sights + 84 food — food by area: LUX 36 · SAAR 14 · MOSELLE 13 · MOSEL 11 · ALSACE 10). Sourced in DE/FR/LU (Saarbrücker Zeitung, SR, Le Républicain Lorrain, DNA, Luxemburger Wort, Tageblatt, Inspire Metz, Michelin/UNESCO/Gault&amp;Millau) + reused US/Europe outlets (Rick Steves, Atlas Obscura). Botanischer Garten Uni Saarland flagged CLOSED. Held-food geocode waves (venue Impressum/Anfahrt/Contact pages, OSM/Mapcarta nodes, geoportail.lu/editus/das-oertliche directories, Wikidata square-anchors) pinned 38 more restaurants (LU +28, DE/FR +10); ~36 remain UNVERIFIED (town-centroid only, no venue-precise decimal exposed to WebSearch) — held for the browser geocode-helper, never town-centroid faked. Rebuild: `python3 tools/rebuild-city.py saarland --build`. |
