...
| Washington DC (+ Arlington + Dulles corridor) | `cities/washingtondc.html` | `data/washingtondc.dataset.json` | `data/washington-dc-research/` | 116 | live · 167 candidates (12 areas incl. FAIRFAX), 51 UNVERIFIED restaurant pins pending helper; closed rooms held |
