...
| Singapore &amp; Southeast Asia (int'l · **pastel light/dark**) | `cities/singapore.html` | `data/singapore.dataset.json` | `data/singapore-research/` | 163 | live · 183 candidates (10 areas: Toa Payoh opening view + SG clusters + MY/TH/VN/ID/PH/IC); opens on Toa Payoh; 20 UNVERIFIED restaurant pins pending helper; 4 closed flagged; per-city sources kept separate |
